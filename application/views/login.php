...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>sistema/vendor/fontawesome-free/css/all.min.css">
  <!-- Custom styles for this template-->
  <!-- <link href="system/css/sb-admin-2.min.css" rel="stylesheet"> -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>sistema/css/sb-admin-2.min.css">
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
       ...
       <div class="col-xl-12 col-lg-11 col-md-9"> 
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image">
                <!-- <img src="sistema/img/fantastico.jpg" class="img-thumbnail"> -->
                <img src="<?php echo base_url(); ?>uploads/fiesta2.jpg" class="img-thumbnail">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
  ...
  <script src="<?php echo base_url(); ?>sistema/vendor/jquery/jquery.min.js"></script>
  <!-- <script src="system/vendor/bootstrap/js/bootstrap.bundle.min.js"></script> -->
  <script src="<?php echo base_url(); ?>sistema/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Core plugin JavaScript-->
  <!-- <script src="sistema/vendor/jquery-easing/jquery.easing.min.js"></script> -->
  <script src="<?php echo base_url(); ?>sistema/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <!-- <script src="system/js/sb-admin-2.min.js"></script> -->
  <script src="<?php echo base_url(); ?>sistema/js/sb-admin-2.min.js"></script>
